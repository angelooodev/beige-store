    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md bg-white/80 dark:bg-mocha-base/80 backdrop-blur-md border border-olive-accent/20 rounded-2xl shadow-xl p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-black text-mocha-dark dark:text-cream-bg">Join the Camp</h1>
          <p className="text-sm text-mocha-light dark:text-cream-bg/70 mt-2">Create your account to start brewing.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-bold text-mocha-light dark:text-cream-bg/80 uppercase tracking-wider mb-1">First Name</label>
              <input
            ...
            <div>
              <label className="block text-xs font-bold text-mocha-light dark:text-cream-bg/80 uppercase tracking-wider mb-1">Last Name</label>
              <input
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-mocha-dark dark:bg-cream-bg text-cream-bg dark:text-mocha-dark font-black py-3 rounded-xl hover:bg-olive-accent dark:hover:bg-olive-accent transition-colors shadow-md mt-6"
          >
        ...
        <p className="text-center text-sm text-mocha-light dark:text-cream-bg/70 mt-6 font-medium">
          Already have an account? <Link to="/login" className="text-olive-accent font-black hover:underline">Log in</Link>
        </p>
      </div>
    </div>
  );
